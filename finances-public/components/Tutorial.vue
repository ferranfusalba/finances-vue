...
<template>
  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <br>
      <h1
        class="flex justify-center pt-8 sm:pt-0 mt-4 pt-4 text-2xl leading-7 font-semibold"
      >
        Finances
      </h1>
      <a
        href="https://app.getfinances.app/"
        target="_blank"
        class="flex justify-center pt-8 sm:pt-0 mt-4 pt-4 text-gray-400"
      >Link to App</a>
      <h6 class="flex justify-center pt-8 sm:pt-0 mt-4 pt-4 text-gray-500">
        dev
        <cv-tooltip
          class="ml-2"
          :alignment="'center'"
          :direction="'bottom'"
          :tip="'The other branch is called master'"
        >
          <svg
            id="icon"
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            <title>fork</title>
            <path
              d="M14.625 10.125a2.248 2.248 0 0 0 -2.17 1.688H10.125a1.69 1.69 0 0 1 -1.688 -1.688V7.875a2.785 2.785 0 0 0 -0.577 -1.688H12.455a2.25 2.25 0 1 0 0 -1.125H5.545a2.25 2.25 0 1 0 0 1.125H5.625a1.69 1.69 0 0 1 1.688 1.688v2.25a2.816 2.816 0 0 0 2.813 2.813h2.33A2.247 2.247 0 1 0 14.625 10.125ZM14.625 4.5a1.125 1.125 0 1 1 -1.125 1.125A1.126 1.126 0 0 1 14.625 4.5ZM3.375 6.75a1.125 1.125 0 1 1 1.125 -1.125A1.126 1.126 0 0 1 3.375 6.75ZM14.625 13.5a1.125 1.125 0 1 1 1.125 -1.125A1.126 1.126 0 0 1 14.625 13.5Z"
            />
            <path
      ...
      <div class="flex justify-center pt-8 sm:pt-0 mt-4 pt-4">
        <cv-button :icon="Datastore32" @click="actionClick">
          Github Repo
        </cv-button>
      </div>
      <!--
...
<script>
import Datastore32 from '@carbon/icons-vue/lib/datastore/32'
...
export default {
  ...
  methods: {
    actionClick () {
      window.open('https://github.com/ferranfusalba/finances-vue', '_blank')
    }
  }
}
</script>
